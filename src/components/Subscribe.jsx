...
const Subscribe = () => {
  ...
  {/* Form */}
  <div className="relative z-10 -mt-55 flex justify-center">
    <div className="relative bg-[#EE4F3C] rounded-2xl px-10 py-12 text-white max-w-4xl w-full shadow-xl">
      ...
      <img
        src="/Decorwhite.png"
        alt="decor"
        className="absolute top-0 right-0 w-40 md:w-56"
      />
